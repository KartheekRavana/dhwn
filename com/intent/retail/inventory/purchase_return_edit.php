          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary" style="overflow: auto;">
                ...
                <table>
                <tr>
                	<td>Slip&nbsp;No</td><td id='bill_no_v'><input type="text" style="width: 150px;float: left" class="form-control" value='<?php echo $measurement_slip_no?>' readonly="readonly" onfocus="finalCost()" id="slip_no" name="slip_no"/></td><td>&nbsp;&nbsp;</td>
	               ...
	               <?php }?>
                	...
                	<input type="number" class="form-control pull-left" id="agent_per" name="agent_per" value='<?php echo $agent_rate?>' placeholder="%" style="width: 80px">
                	</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                 <tr>
              ...
              <div class="box" style="overflow: auto;">
	            ...
	            <tr><td>&nbsp;</td></tr>
                  ...
                  <!-- /.box-body -->
					...
					<input type="submit" class="btn btn-block btn-warning" value="Update Bill">
				  </div>             
