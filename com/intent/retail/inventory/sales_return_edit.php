 ...
 <?php include_once "$D_PATH/include/scripts_top.php";?>
  ...
  <div class="content-wrapper">
    ...
    <?php include_once "$D_PATH/include/navigation.php";?>
          ...
          <form role="form" onsubmit="return validate()" action="index.php?action=operations/out_return_edit&c=inventory" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary" style="overflow: auto;">
                ...
                $customer_name_cash="";
                $data = mysql_query("SELECT sk_bill_id, bill_date, bill_time,slip_no, member_id,transporter_rate, member_name, mobile, place, bill_for, bill_type, bill_amount, tax_rate, tax_amount, t_discount_rate, t_discount_amount, bill_tax_amount, transporter_id, transport_amount, other_expenses, grand_total, cash_amount, check_amount, paid_amount, discount, balance_amount, note, bank_id, bill_status, measurement_slip_no,agent_id,agent_rate,agent_amount, employee_id, branch_id FROM mst_bill_main where sk_bill_id=$bill_no");
                while($info = mysql_fetch_array( $data ))
                {
					...
					$transporter_rate=$info["transporter_rate"];
                ...
                <tr>
                	...
                	<select  name="agent_id" id="agent_id" class="form-control select2 pull-left" data-live-search="true" data-live-search-style="begins" title="Please select a Agent ..." style="width: 150px"  onchange="getAgent(this.value)">
                	 <?php 
              ...
              <div class="box" style="overflow: auto;">
	           ...
	           $data = mysql_query("SELECT sk_tran_id, bill_id, bill_for, bill_type, bill_date, particular_id, qty_in_piece, qty_in_sft, rate, amount, bill_status, employee_id, branch_id FROM txn_bill_support where bill_id='".$bill_no."' and qty_in_sft>0");
	           while($info = mysql_fetch_array( $data ))
	           {
              ...
              <td><select class="form-control" id="category<?php echo $i?>" name="category<?php echo $i?>" onchange="loadItems(<?php echo $i?>,this.value)"><option value="<?php echo $category_id?>"><?php echo $category_name?></option><?php $data1 = mysql_query("SELECT sk_particular_id, particular_name FROM mst_particular where particular_status='active' and category_id=0 and branch_id='".$session_branch."'");while($info1 = mysql_fetch_array( $data1 )){?><option  value="<?php echo $info1["sk_particular_id"]?>"><?php echo $info1["particular_name"]?></option><?php }?></select></td><td>&nbsp;&nbsp;</td>
                ...
                <td><input type="text" class="form-control" onkeypress="return isDecimalNumber(event,this);" value="<?php echo $item_qty?>" id="qty_sft<?php echo $i?>" name="qty_sft<?php echo $i?>" size="5" onblur="checkQty(<?php echo $i?>)"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" onkeypress="return isDecimalNumber(event,this);" value="<?php echo $item_rate?>" id="cost<?php echo $i?>" name="cost<?php echo $i?>" size="5" onblur="calCost(<?php echo $i?>)"></td><td>&nbsp;&nbsp;</td>
          ...
          <div class="col-md-3">
              ...
              <div class="box" style="overflow: auto;">
                ...
                <br/>
	             ...
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Tax*<input type='text' name='tax_rate' id='tax_rate' value="<?php echo $tax_rate?>" size='2' onblur="finalCost()">%</td><td id='tax_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control" onfocus="finalCost()" value="<?php echo $tax_amount?>" id="tax" name="tax"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>T&nbsp;Disc*<input type='text' name='tax_disc' id='tax_disc' value="<?php echo $tax_discount_rate?>" size='1' onblur="finalCost()">%</td><td id=''><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control" onfocus="finalCost()" value="<?php echo $tax_discount?>" id="tax_disc_amt" name="tax_disc_amt"/></td></tr>
	             ...
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Trans&nbsp;Amt*<input type='text' name='transporter_rate' id='transporter_rate' value="<?php echo $transporter_rate?>" size='1' onblur="finalCost()"></td><td id='transport_v'><input type="text" value="<?php echo $transport_amount?>" onkeypress="return isDecimalNumber(event,this);" class="form-control"  onblur="finalCost()" id="transport" name="transport"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
...
document.getElementById("fcost"+count).value=parseFloat(qty*cost);
...
document.getElementById("transport").value=total_sft*transporter_rate;
}else{
