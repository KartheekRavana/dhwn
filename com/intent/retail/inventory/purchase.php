 ...
 <?php include_once "$D_PATH/include/scripts_top.php";?>
  ...
  <div class="content-wrapper">
    ...
    <?php include_once "$D_PATH/include/navigation.php";?>
        ...
        <form role="form" onsubmit="return validate()" action="?action=operations/in_save&c=inventory" method="POST">
...
while ($row = mysql_fetch_assoc($result))
{
	$slip_no = $row['maxid'];
                ...
                <table>
                <tr>
                	<td>Slip No</td><td id='bill_no_v'><input type="text" class="form-control"  onfocus="finalCost()" id="slip_no" name="slip_no" value="<?php echo $slip_no?>" style="width: 150px;float: left"/></td><td>&nbsp;&nbsp;</td>
                	...
                	<td>Bill&nbsp;Type</td><td id='bill_type_v'><select style="width: 80px;float: left" class="form-control" id="bill_type" name="bill_type" onchange="checkCustomer(this.value)"><option value="Credit">Credit</option><option value="Cash">Cash</option></select>
	               ...
	               <?php }?>
                	...
                	<input type="text" onblur="finalCost()"  class="form-control pull-left" id="agent_per" name="agent_per" placeholder="%" style="width: 80px">
                	</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                 <tr>
                 ...
                 ?>
                	...
                	<select  name="customer_id" id="customer_id" onchange="getCustomer(this.value)" class="form-control select2" data-live-search="true" data-live-search-style="begins" title="Please select a customer ..." style="width: 150px">
                	<option value=""></option>
                	 <?php 
                                   
                                  $data = mysql_query("SELECT sk_member_id,member_name FROM mst_member where branch_id='$session_branch' and member_type='3' order by member_name asc");
                                  while($info = mysql_fetch_array( $data ))
                                  {
                                  ?>  
	               <option  value="<?php echo $info["sk_member_id"]?>"><?php echo $info["member_name"]?></option>
                ...
                <td>C Mnt in%</td><td id='place_v'><input type="text" class="form-control" id="cmeasurement" name="cmeasurement" style="width: 160px" value='0'></td><td>&nbsp;&nbsp;</td>
              ...
              <div class="box" style="overflow: auto;max-height: 400px">
                ...
                {$item_id="";
	                ...
	                <td><input type="text" style="padding: 0" class="form-control" value="<?php echo $sft?>" onkeypress="return isDecimalNumber(event,this);" id="qty_sft<?php echo $k?>" name="qty_sft<?php echo $k?>" size="5" onblur="finalCost()"></td><td>&nbsp;&nbsp;</td>
	                <td><input type="text" style="padding: 0" class="form-control" onkeypress="return isDecimalNumber(event,this);" id="cost<?php echo $k?>" name="cost<?php echo $k?>" size="5" onblur="finalCost()"></td><td>&nbsp;&nbsp;</td>
          ...
          <div class="col-md-3">
              ...
              <div class="box">
	            ...
	            <tr><td>&nbsp;</td></tr>
	             <tr><td>Invoice&nbsp;Amount*</td><td id='grand_total_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" value=0 class="form-control" onblur="finalCost()" id="invoice_amt" name="invoice_amt"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Tax<input type='text' name='tax_rate' id='tax_rate' value="0" size='2' onblur="finalCost()"></td><td id='tax_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control" onfocus="finalCost()" id="tax" name="tax" value="0"></td></tr>
	         ...
	         <tr><td>Other&nbsp;Expenses* </td><td id='other_expenses_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control" onblur="finalCost()" id="other_expenses" value='0' name="other_expenses"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Total&nbsp;Amount*</td><td id=''><input type="text" readonly="readonly" onkeypress="return isDecimalNumber(event,this);" class="form-control" onfocus="finalCost()" id="total_amt" name="total_amt"/></td></tr>
	              <tr><td>&nbsp;</td></tr>
	             <tr><td>Vat<input type='text' name='vat_rate' id='vat_rate' value="14.5" size='3' onblur="finalCost()"></td><td id='tax_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control" onfocus="finalCost()" id="vat" name="vat" value="0"></td></tr>
	             <tr><td>&nbsp;</td></tr>
	            
	              <tr><td>Transporter*</td><td id=''><select class="form-control" onfocus="finalCost()" id="transporter_id" name="transporter_id">
	              
	              <?php 
	              $data = mysql_query("SELECT sk_member_id, member_name from mst_member where member_status='active' and member_type='4' order by member_name asc");
	              while($info = mysql_fetch_array( $data ))
	              {
	              ?>
	              <option value="<?php echo $info["sk_member_id"]?>"><?php echo $info["member_name"]?></option>
	             ...
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Hamali&nbsp;Amount*</td><td id='hamali_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control"  onblur="finalCost()" id="hamali" name="hamali"/></td></tr>
	            
	         <tr><td>&nbsp;</td></tr>
	          <tr><td>Purchase&nbsp;Expeses*</td><td id='hamali_v'><input type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control"  onblur="finalCost()" id="purchase_exp" name="purchase_exp"/></td></tr>
          ...
          <div class="col-md-3" style="display: none">
              ...
              <div class="box">
                ...
                <br/>
                  ...
                  <input type='hidden' name='count' id='count' value="<?php echo $i?>">
                  <table>
                   <tr><td>Cash&nbsp;Amount*</td><td id='cash_amount_v'><input value='0' type="text" onkeypress="return isDecimalNumber(event,this);" onblur="cashe()" class="form-control" onfocus="finalCost()" id="cash_amount" name="cash_amount"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Check&nbsp;Amount*</td><td id='check_amount_v'><input value='0' type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control"  onblur="unHide();Paid()" id="check_amount" name="check_amount"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	             
                    <tr><td>Paid&nbsp;Amount*</td><td id='paid_amt_v'><input value='0' type="text" onkeypress="return isDecimalNumber(event,this);" readonly="readonly" class="form-control" onfocus="Paid()" id="paid_amt" name="paid_amt"/></td></tr>
	                <tr><td>&nbsp;</td></tr>
	                 <tr><td>Discount*</td><td id='discount_v'><input value='0' type="text" onkeypress="return isDecimalNumber(event,this);" class="form-control" onblur="Balance()" id="discount" name="discount"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
...
agent_amt=(grand_total/100)*agent_per
