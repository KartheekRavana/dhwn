 ...
 <?php include_once "$D_PATH/include/scripts_top.php";?>
  ...
  <div class="content-wrapper">
    ...
    <?php include_once "$D_PATH/include/navigation.php";?>
        ...
        <form role="form" onsubmit="return validate()" action="?action=operations/out_return&c=inventory" method="POST">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary" style="overflow: auto;">
				...
				$slip_no=$_GET["m"];
				                 ...
				                 $slip_no=0;
$command = "SELECT count(sk_bill_id) as maxid FROM mst_bill_main where `bill_type` LIKE  '%ret%'  and bill_for='Customer' ";
  ...
  $mobile="";
              ...
              <div class="box" style="overflow: auto;max-height: 400px">
                ...
                {$item_id="";
	                ...
	                <td><input type="text" style="padding: 0" class="form-control" value="<?php echo number_format($sft, 3, '.', '');?>" onkeypress="return isDecimalNumber(event,this);" id="qty_sft<?php echo $k?>" name="qty_sft<?php echo $k?>" size="5" onblur="checkQty(<?php echo $k?>)"></td><td>&nbsp;&nbsp;</td>
