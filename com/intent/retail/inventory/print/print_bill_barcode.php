    ...
    <body class="interface">
        ...
        <div class="content">
            ...
            <!-- ==================== WIDGETS CONTAINER ==================== -->
                ...
                <!-- ==================== COMMON ELEMENTS ROW ==================== -->
                <div class="row-fluid">
                    <div class="row-fluid" style="width:100%;margin-left:0px;font-size: 12px">  
...
while($info1 = mysql_fetch_array( $data1 ))
{
	$c=$info1["member_name"];
	          ...
	          ?>
	           ...
	           <tr><th></th><th>ITEMS</th><th>QTY</th><th>COST</th><th>DISC</th><th>TOTAL</th></tr>
	           
	           <?php 
	           $i=1;$items_list="";
	           $data = mysql_query("SELECT `sk_tran_id`, `bill_id`, `bill_for`, `bill_type`,description,note, `bill_date`, `particular_id`, `qty_in_piece`, `qty_in_sft`, `rate`, `amount`,`discount`, `landing_cost`, `bill_status`, `employee_id`, `branch_id` FROM txn_bill_support where bill_id='".$b_no."'");
	           while($info = mysql_fetch_array( $data ))
	           {
	           ...
	           <td style="width: 150px">
	           		...
	           		<td style="text-align: right;"><?php echo number_format($info["discount"], 2, '.', '')?></td>
