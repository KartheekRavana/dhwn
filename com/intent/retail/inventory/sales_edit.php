            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <table style="float: right;"><tr>
	               ...
	               <?php }?>
                	...
                	<input type="text" class="form-control pull-left" id="agent_per" name="agent_per" placeholder="%" style="width: 80px">
                	</td>
              ...
              <div class="box">
               ...
               <input type='hidden' id="piece_sft_<?php echo $i?>">
                ...
                <td><input type="text" class="form-control" style="padding: 0" value="<?php echo $discount?>" onkeypress="return isNumberKey(event)" id="discount<?php echo $i?>" size="5" onblur="calCost(<?php echo $i?>)"></td><td>&nbsp;&nbsp;</td>
	 ...
	 function totalSft(count)
	   {
          ...
          <div class="col-xs-3">
	         ...
	         <tr><td>&nbsp;</td></tr>
	             ...
	             <tr><td>Note*</td><td><input type="text" class="form-control" value='<?php echo $bill_note?>' id="note" name="note"/></td></tr> 
	            <tr><td>&nbsp;</td></tr>
	             ...
	             <tr><td>&nbsp;</td></tr>
	                ...
	                <tr><td>&nbsp;</td></tr>
	                 <tr><td>Discount*</td><td id='discount_v'><input type="text" value="<?php echo $discount?>" onkeypress="return isNumberKey(event)" class="form-control" onblur="Balance()" id="discount" name="discount"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
