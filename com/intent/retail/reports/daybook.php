	    ...
	    $agent_com=0;
	     ...
	     $hamali=0;
                    ...
                    $data = mysql_query("SELECT sk_tran_id,tran_date,credit,tran_desc,member_id,transaction_ref_id FROM txn_transaction where tran_type='Customer' and tran_desc='Payment Return' and credit>0 $q");
	                	...
	                	$opening=($received_amt+$credit_payment+$bank_withdraw+$hand_loan+$other_income_ledger+$investment_deposit_ledger)-($expense+$customer_return+$supplier_payments+$bank_deposit+$transport+$agent_com+$employee_payment+$partner_payment+$hand_loan_issue+$hamali+$rent+$investment_payment_ledger);
            ...
            <div class="col-md-4">
              <div class="box">
                ...
                <table id="" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    ?><tr>
                    	<td><a href="?action=sales_edit&c=stock&bill_no=<?php echo $info["transaction_ref_id"]?>"><?php echo $slip_no?></a></td>
              ...
              <div class="box">
                ...
                <table id="" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Partner Investment</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <table id="" class="table table-bordered table-striped" style="font-size: 12px">
                    <thead>
                    ...
                    <td><?php echo $info["tran_desc"]?></td>
                    <td><?php echo $member_name?></td>
                    <td><a href="javascript:void(0)" onclick="setData(<?php echo $info["sk_tran_id"]?>,<?php echo $info["credit"]?>,'<?php echo $member_name?>','credit')" data-toggle="modal" data-target="#myModal"><?php echo $info["credit"]?></a></td>
                    </tr>
                    
                    <?php }}?>
                                </tbody>
                                    <tfoot>
                                    <tr><td></td><td></td><td></td><td><?php echo $investment_return?></td></tr>
                                    </tfoot>
                  </table>
            ...
            $data = mysql_query("SELECT sk_tran_id,tran_date,debit,tran_desc,member_id,note FROM txn_transaction where tran_type='Expense' and debit>0 $q");
              ...
              <div class="box">
                ...
                <table id="" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <?php }
	                	 $data = mysql_query("SELECT sk_tran_id,tran_date,credit,debit,tran_desc,member_id,transaction_ref_id FROM txn_transaction where tran_type='Customer' and tran_desc='Return Bill' and member_id=0 and debit>0 $q");
	                	while($info = mysql_fetch_array( $data ))
	                	{      
						$member_name="";
						$member_id=$info["member_id"];
                    ...
                    <td><a href='javascript:void(0)'  data-toggle="modal" data-target="#myModal" onclick="setData(<?php echo $info["sk_tran_id"]?>,<?php echo $info["debit"]?>,'<?php echo $bank_name?>','debit')"><?php echo $info["debit"]?></a></td>
                    </tr>
              ...
              <div class="box">
                ...
                <table id="" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <?php }}?>
                                    ...
                                    <tfoot>
                                    <tr><td></td><td></td><td></td><td><?php echo $investment_payments?></td></tr>
                                    </tfoot>
                  </table>
