            ...
            <div class="col-md-8">
              ...
              <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title">Banned Category List</h3>
                  <span class='pull-right'><a href="?action=category&c=particluars">View Active Categories</a></span>
                </div><!-- /.box-header -->
                <div class="box-body">
                 <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <tr>
                         ...
                         <td><a href='?action=operations/category_activate&c=particluars&cid=<?php echo $info['sk_particular_id']?>&page=category_banned'><span class="label label-success">Activate</span></a> </td>
                    </tr>
                    <?php }?>
