...
$query ="update mst_particular set particular_status='active' where sk_particular_id='$particular_id'";
mysql_query($query);
...
VALUES ('$log_id','$date',now(),'Category','Activated','Category Activated','mst_particular','$particular_id','0','0','$session_branch','$session_id')";
mysql_query($query);
//**********************************LOG END****************************************************
...
?>
<script>
window.location="?action=<?php echo $page?>&c=particluars&status=success//Successfully Activated Category";
</script>