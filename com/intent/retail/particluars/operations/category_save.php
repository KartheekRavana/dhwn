...
VALUES ('$cNo','$category','$category','0','0','active','$session_branch')";
mysql_query($query);
...
VALUES ('$log_id','$date',now(),'Category','New','New $category Added','mst_particular','$cNo','0','0','$session_branch','$session_id')";
mysql_query($query);
//**********************************LOG END****************************************************
?>
<input type='hidden' name="status" id="status" value="<?php echo $commit?>">
<script>
window.location="?action=category&c=particluars&status=success//Successfully Added New Category";
</script>