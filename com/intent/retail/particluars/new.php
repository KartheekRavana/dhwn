    ...
    <?php include_once "$D_PATH/include/navigation.php";?>
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
            <form role="form" onsubmit="return validate()" action="?action=operations/particular_save&c=particluars" method="POST">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="particluar" name="particluar" placeholder="Enter Particular Name" required="required">
                    </div>
                      <div class="form-group">                  
					<button class="btn btn-block btn-success">Add Particular</button>
				  </div>  
            ...
            <div class="col-md-8">
              ...
              <div class="box box-warning">
                <div class="box-header">
                  ...
                  <span class='pull-right'><a href="?action=particular_banned&c=particluars">View Banned</a></span>
                </div><!-- /.box-header -->
                <div class="box-body">
                 <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                    ...
                    <tr>
                         ...
                         <td><a href='?action=operations/category_ban&c=particluars&cid=<?php echo $info['sk_particular_id']?>&page=new'><span class="label label-danger">Ban</span></a> 
                         | <a href='?action=edit&c=particluars&cid=<?php echo $info['sk_particular_id']?>&page=new'><span class="label label-warning">Edit</span></a></td>
                    </tr>
                    <?php }?>
