...
else
{
 ...
 function finalCost()
 {
	...
	document.getElementById("cash_amount").value=parseFloat(document.getElementById("total").value).toFixed(2);
	cashe();
	Paid();
	Balance();
 	}
 	else
 	{
 		...
 		document.getElementById("balance").value=parseFloat(document.getElementById("total").value).toFixed(2);
 	}
 ...
 function cashe()
 {
 	...
 	document.getElementById("check_amount").value=parseFloat(document.getElementById("total").value-document.getElementById("cash_amount").value).toFixed(2);
 	unHide()
 }
 ...
 function Balance()
 {
	 document.getElementById("balance").value=parseFloat(document.getElementById("total").value)-(parseFloat(document.getElementById("paid_amt").value)+parseFloat(document.getElementById("discount").value)).toFixed(2);
 }
...
function getAllItem(row)
{
  ...
  <script type="text/javascript">
        ...
        {
            val=document.getElementById("barcode").value;
...
<!-- ---------------------------------------------------POPUP--------------------------------------------------------------------------- -->  
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          ...
          <form role="form" onsubmit="return validate()" name='myForm' action="index.php?action=operations/out_save&c=stock" method="POST">
          <?php $pid=0;
           if(isset($_GET["pid"])){
          
           	$pid=$_GET["pid"]; }?> <input type='hidden' id='pid' name='pid' value='<?php echo $pid?>'>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <tr>
                	...
                	<select  name="customer_id" id="customer_id" class="form-control" style="position: relative ;width: 150px"  onchange="getMember(this.value)">
                	<option value=""></option>
                	 <?php 
	             ...
	             <tr><td>&nbsp;</td></tr>	             
	               ...
	               <option value=""></option>
	                <?php 
                                  ...
                                  $data = mysql_query("SELECT sk_member_id,member_name FROM mst_member  where member_type=6 order by member_name asc");
                                  if($data)
                                  while($info = mysql_fetch_array( $data ))
                                  {
                                  ?>  
