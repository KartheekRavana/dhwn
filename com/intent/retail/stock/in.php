          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box">
                ...
                <tr><th></th><td>&nbsp;&nbsp;</td><th>Category<a href="" class='click'>+</a></th><td>&nbsp;&nbsp;</td>
               <th>Sub Category<a href="" class='click'>+</a></th><td>&nbsp;&nbsp;</td>
                <th>Items&nbsp;&nbsp;&nbsp;<a href="" class='click'>+</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><td>&nbsp;&nbsp;</td>
                <td></td><td></td><th>In&nbsp;Piece</th><td>&nbsp;&nbsp;</td><th>Cost</th><td>&nbsp;&nbsp;</td><th>Final Cost</th>
                ...
                <td><select class="form-control" id="subcategory<?php echo $i?>" name="subcategory<?php echo $i?>" onchange="loadItems1(<?php echo $i?>,this.value)"><option value=""></option></select></td><td>&nbsp;&nbsp;</td>
                <td><select class="form-control" id="item<?php echo $i?>" name="item<?php echo $i?>"><option value=""></option></select></td><td>&nbsp;&nbsp;</td>
                <td ><input type="hidden"  class="form-control onlyNumbers" id="qty_piece<?php echo $i?>" name="qty_piece<?php echo $i?>" size="1" value="0"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" onkeypress="return isNumberKey(event)" id="qty_sft<?php echo $i?>" name="qty_sft<?php echo $i?>" size="3"></td><td>&nbsp;&nbsp;</td>
                ...
                <td><input type="text" class="form-control" id="lcost<?php echo $i?>" name="lcost<?php echo $i?>" readonly="readonly"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" id="tlcost<?php echo $i?>" name="tlcost<?php echo $i?>" readonly="readonly"></td><td>&nbsp;&nbsp;</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <?php }?>
                 <?php 
                ...
                <td><select class="form-control" id="subcategory<?php echo $i?>" name="subcategory<?php echo $i?>" onchange="loadItems1(<?php echo $i?>,this.value)"><option value=""></option></select></td><td>&nbsp;&nbsp;</td>
                <td><select class="form-control" id="item<?php echo $i?>" name="item<?php echo $i?>"><option value=""></option></select></td><td>&nbsp;&nbsp;</td>
                <td ><input type="hidden" class="form-control onlyNumbers" id="qty_piece<?php echo $i?>" name="qty_piece<?php echo $i?>" value="0"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" onkeypress="return isNumberKey(event)" id="qty_sft<?php echo $i?>" name="qty_sft<?php echo $i?>"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" onkeypress="return isNumberKey(event)" onkeypress="return isNumberKey(event)"  id="cost<?php echo $i?>" name="cost<?php echo $i?>" onblur="calCost(<?php echo $i?>)"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" id="fcost<?php echo $i?>" name="fcost<?php echo $i?>" readonly="readonly"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" id="lcost<?php echo $i?>" name="lcost<?php echo $i?>" readonly="readonly"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control" id="tlcost<?php echo $i?>" name="tlcost<?php echo $i?>" readonly="readonly"></td><td>&nbsp;&nbsp;</td>
          ...
          <div class="col-xs-3">
              ...
              <div class="box">
                ...
                <br/>
                  ...
                  <input type='hidden' name='count' id='count' value="<?php echo $i?>">
                  <table>
	             <tr><td>Total&nbsp;Amount*</td><td><input type="text" class="form-control" onfocus="calFinalCost()" id="grand_total" name="grand_total" readonly="readonly"/></td></tr> 
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Other&nbsp;Exp*</td><td id="other_expenses_v"><input type="text" onkeypress="return isNumberKey(event)" class="form-control" onfocus="calFinalCost()" id="other_expenses" name="other_expenses"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	             <tr><td>Transport&nbsp;Amount*</td><td id="transport_expenses_v"><input type="text" onkeypress="return isNumberKey(event)" class="form-control"  onblur="calFinalCost()" id="transport_expenses" name="transport_expenses"/></td></tr>
	             <tr><td>&nbsp;</td></tr>
	         <tr><td>Hamali* </td><td id="hamali_expenses_v"><input type="text" class="form-control" onkeypress="return isNumberKey(event)" onblur="calcalFinalCost()" id="hamali_expenses" name="hamali_expenses" value='0' /></td></tr>
	         <tr><td>&nbsp;</td></tr>
	               <tr><td>Total Value*</td><td><input type="text" class="form-control" onfocus="calFinalCost()" id="total" name="total" readonly="readonly"/> </td></tr>  
	             <tr><td>&nbsp;</td></tr>
