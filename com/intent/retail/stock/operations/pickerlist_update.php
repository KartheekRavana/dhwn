...
else
{
	if($customer_name!="" && $c_id=="")
	{
		...
		$query="update customerpickermain set bill_date='$bill_date',total='$grand_total',total_bal='$total',login_id='$session_id',branch='$session_branch',customer_name='$customer_name',phone='$mobile',city='$place',transport='$transport' where bill_no='$bill_no' ";
		
		mysql_query($query) or die('Query "' . $query . '" failed: ' . mysql_error());
		
		$query="delete from  customerpicker where bill_no='$bill_no' ";
...
<table cellspacing=0 cellpadding=0 border="#000" style="width: 100%;font-size: 12px">
	           <tr><th>Particulars&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Qty</th><th>Rate</th><th>Discount</th><th>Amount</th></tr>
...
<script>
self.print();
window.location="index.php?action=picker_list&c=stock";
</script>