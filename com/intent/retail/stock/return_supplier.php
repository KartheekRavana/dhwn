    ...
    <script type="text/javascript">
		...
		{			
			...
			for(var i=1;i<count;i++)
			{
				...
				if( item!="" && qty_piece!="" && qty_sft!="" && cost!="" && fcost!="" && lcost!="" && tlcost!="")
				{
					
					data=data+"//"+category+"#"+item+"#"+qty_piece+"#"+qty_sft+"#"+cost+"#"+fcost+"#"+lcost+"#"+tlcost+"#"+subid+"#"+discount+"#"+desc+"#"+barcode+"#"+vat;
				}
...
function getProductCost(row,desc){
	...
	$.ajax({
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          ...
          <form role="form" name="myform" onsubmit="return validate()" action="index.php?action=operations/return_save&c=stock" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <br/>
                  <?php $supplier_id=0;$bill_no=0;$supplier_name="";$supplier_id="";$mobile="";$city="";
                  if(isset($_GET["c_id"])){
                $supplier_id=$_GET["c_id"];
                $bill_no=$_GET["pid"];
                 
                $data = mysql_query("SELECT sk_member_id, member_name, place, mobile FROM mst_member where sk_member_id=$supplier_id");
                while($info = mysql_fetch_array( $data ))
                {
                	$supplier_name=$info['member_name'];
                	$supplier_id=$info['sk_member_id'];
                	$mobile=$info['mobile'];
                	$city=$info['place'];                	
                }
                   }
                ...
                <tr>
                	...
                	<td>Return Bill&nbsp;Date</td><td id='bill_date_v'><input type="date" class="form-control" id="bill_date" name="bill_date" value="<?php echo $bill_date?>" size="9"></td><td>&nbsp;&nbsp;</td>
           ...
           <input type="hidden" id="row">
             ...
             <div class="col-xs-9">
              ...
              <div class="box">
                ...
                <th>Items</th><td>&nbsp;&nbsp;</td>
                <th>Desc</th><td>&nbsp;&nbsp;</td>
                <th>In&nbsp;Piece</th><td>&nbsp;&nbsp;</td><th>Sft/Box</th><td>&nbsp;&nbsp;</td><th>Cost</th><td>&nbsp;&nbsp;</td><th>Disc%</th><td>&nbsp;&nbsp;</td><th>GST%</th><td>&nbsp;&nbsp;</td><th>Final Cost</th>
                <td>&nbsp;&nbsp;</td><th>Lan Cost</th><td>&nbsp;&nbsp;</td><th></th><th></th><th>Barcode</th></tr>
                <?php 
                $i=0;
                $k="";
                $itemname="";
                ...
                $breadth="";
                $thickness="";
                $query=mysql_query("select tran_id,item_name,item_qty,item_rate,amt,landing_cost,item_qty_p,discount,description,vat from supplierorderform where bill_no='$bill_no'  order by tran_id asc");
	...
	while($info3 = mysql_fetch_array($data3))
	{
		...
		$item_rate=$info3["rate"];
                ...
                <td><input type="text" style="padding: 0" class="form-control" onkeypress="return isDecimalNumber(event,this);" id="cost<?php echo $i?>" name="cost<?php echo $i?>" size="5" onblur="calCost(<?php echo $i?>)" value="<?php echo $item_rate?>">
                 
                </td><td>&nbsp;&nbsp;</td>
                <td><input type="text" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="discount<?php echo $i?>" name="discount<?php echo $i?>" onblur="calCost(<?php echo $i?>)" value="<?php echo $discount?>" size="3"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" value="<?php echo $vat?>" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="vat<?php echo $i?>" value="<?php echo $vat?>" name="vat<?php echo $i?>" onblur="calCost(<?php echo $i?>)" size="3"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control" id="fcost<?php echo $i?>" name="fcost<?php echo $i?>" readonly="readonly" size='4' value="<?php echo $info["amt"]?>"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control" id="lcost<?php echo $i?>" name="lcost<?php echo $i?>" readonly="readonly" size='4' value="<?php echo $info["landing_cost"]?>"></td><td>&nbsp;&nbsp;</td>
                <td><input type="hidden" class="form-control" id="tlcost<?php echo $i?>" name="tlcost<?php echo $i?>" readonly="readonly" ></td><td>&nbsp;&nbsp;</td>
                  <td><input type="text" style="padding: 0" class="form-control" id="barcode<?php echo $i?>" value="" size='4'></td>
                ...
                <td><input type="text" style="padding: 0" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="cost<?php echo $i?>" name="cost<?php echo $i?>" size="5"  onblur="calCost(<?php echo $i?>)">
                <input type="hidden" id="cost<?php echo $i?>">
                </td><td>&nbsp;&nbsp;</td>
                
                <td><input type="text" style="padding: 0" value="0" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="discount<?php echo $i?>" name="discount<?php echo $i?>" onblur="calCost(<?php echo $i?>)" size="3"></td><td>&nbsp;&nbsp;</td>
               <td><input type="text" style="padding: 0" value="0" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="vat<?php echo $i?>" name="vat<?php echo $i?>" onblur="calCost(<?php echo $i?>)" size="3"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control removespace" id="fcost<?php echo $i?>" name="fcost<?php echo $i?>" readonly="readonly" size='4'></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control removespace" id="lcost<?php echo $i?>" name="lcost<?php echo $i?>" readonly="readonly" size='4'></td><td>&nbsp;&nbsp;</td>
                <td><input type="hidden" class="form-control" id="tlcost<?php echo $i?>" name="tlcost<?php echo $i?>" readonly="readonly"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control" id="barcode<?php echo $i?>" value="" size='4'></td>
                ...
                <br/>
	             ...
	             <tr><td>&nbsp;</td></tr>
                  ...
                  <!-- /.box-body -->
                    ...
                    <div class="form-group">      
                    <input type="button" class="btn btn-block btn-success" onclick="calFinalCost();validate()" value="Add Stock">             
