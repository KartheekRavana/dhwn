...
<!-- ---------------------------------------------------POPUP--------------------------------------------------------------------------- -->  
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          ...
          <form role="form" onsubmit="return validate()" name='myForm' action="index.php?action=operations/pickerlist_save&c=stock" method="POST">
            ...
            <div class="col-md-12">
              ...
              <div class="box">
               ...
               <input type='hidden' id="piece_sft_<?php echo $i?>">
                ...
                <td><input type="text" class="form-control" style="padding: 0" id="fcost<?php echo $i?>" name="fcost<?php echo $i?>" readonly="readonly"></td>
                <td style="visibility: hidden;" id="clear<?php echo $i?>"><a href="javascript:void(0)" onclick="calCost(<?php echo $i?>);clearData(<?php echo $i?>)"><img title="Clear" src="<?php echo $UI_ELEMENTS?>/images/clear.png" width="20px"></a>
                </td>
                <td></td>
                </tr>
                <tr><td>&nbsp;</td></tr>
	         ...
	         <tr><td>&nbsp;</td></tr>
	            ...
	            <tr><td>&nbsp;</td></tr>
                  ...
                  <!-- /.box-body -->
                    ...
                    <div class="form-group">                  
					<input type="submit" class="btn btn-block btn-success" value="Create Picker List" onclick="Balance()">
				  </div>             
