    ...
    <script type="text/javascript">
		...
		{			
			...
			for(var i=1;i<count;i++)
			{
				...
				var curStock=document.getElementById("item_stock"+i).value
...
$.ajax({
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          ...
          <form role="form" name="myform" onsubmit="return validate()" action="index.php?action=operations/orderform_save&c=stock" method="POST">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <tr>
                	...
                	<td>Order&nbsp;Date</td><td id='bill_date_v'><input type="date" class="form-control" id="bill_date" name="bill_date" value="<?php echo $date?>" size="9"></td><td>&nbsp;&nbsp;</td>
	               ...
	               <option value=""></option>
	                <?php 
                                  ...
                                  $data = mysql_query("SELECT sk_member_id,member_name FROM mst_member where member_type='3' and member_status='active' order by member_name asc");
                                  if($data)
                                  while($info = mysql_fetch_array( $data ))
                                  {
                                  ?>  
              ...
              <div class="box" >
               ...
               <tr>
                ...
                <td><select class="form-control" id="category1" name="category1" onchange="loadItems(1,this.value)"><option value=""></option><?php $data = mysql_query("SELECT category_id,category_name FROM category where category_status='active'");if($data)while($info = mysql_fetch_array( $data )){?><option  value="<?php echo $info["category_id"]?>"><?php echo $info["category_name"]?></option><?php }?></select></td>
                <td>&nbsp;&nbsp;</td>
           ...
           <input type="hidden" id="row">
             ...
             <div class="col-xs-9">
              ...
              <div class="box">
                ...
                <td>&nbsp;&nbsp;</td><th></th><td>&nbsp;&nbsp;</td><th></th><th></th><th>Barcode</th></tr>
                <?php 
                for($i=1;$i<=120;$i++)
                {
                ...
                <td><input type="hidden" class="form-control" id="item<?php echo $i?>">
                	<input type="text" class="form-control removespace" id="item_name<?php echo $i?>" style="padding: 0">
                </td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control removespace" onkeyup="suggest(this.value,<?php echo $i?>);" onchange="" onblur="fill(22222);fillId();" id="desc<?php echo $i?>">
                ...
                <td><input type="text" style="padding: 0" class="form-control onlyNumbers removespace" id="qty_piece<?php echo $i?>" size="1" onblur="calLength(<?php echo $i?>);totalSft(<?php echo $i?>)"></td><td>&nbsp;&nbsp;</td>
                <td><input type="text" style="padding: 0" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="qty_sft<?php echo $i?>" onfocus="" size="3"></td><td>&nbsp;&nbsp;</td> 
                ...
                <td>&nbsp;&nbsp;<input type="hidden" style="padding: 0" value="0" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="discount<?php echo $i?>" onblur="calCost(<?php echo $i?>)" size="3">
				<input type="hidden" style="padding: 0" value="0" class="form-control removespace" onkeypress="return isDecimalNumber(event,this);" id="vat<?php echo $i?>" onblur="calCost(<?php echo $i?>)" size="3"></td>
                <td><input type="hidden" style="padding: 0" class="form-control removespace" id="fcost<?php echo $i?>" value=0 readonly="readonly" size='4'></td><td>&nbsp;&nbsp;</td>
                <td><input type="hidden" style="padding: 0" class="form-control removespace" id="lcost<?php echo $i?>" value=0 readonly="readonly" size='4'></td><td>&nbsp;&nbsp;</td>
