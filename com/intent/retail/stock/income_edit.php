      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            <!-- left column -->
            <div class="col-md-4">
             <form role="form" onsubmit="return validate()" action="index.php?action=operations/income_edit&c=stock" method="POST">
                ...
                ?>
                  <div class="box-body">
                    ...
                    <div class="form-group" id="date_v">
                      ...
                      <input type="date" class="form-control" id="date" name="date" placeholder="Expense Date" value='<?php echo $TRAN_DATE?>'> 
                    </div>
					...
					<button class="btn btn-block btn-success">Update Income</button>
				  </div>             
