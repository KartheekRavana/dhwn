  ...
  <head>
    ...
    <script type="text/javascript">
		...
		{			           
			...
			var result = confirm("Are Your Sure, Want to Update Advance?");
			if (result) {
				return true;
			}else{return false;}
...
<!-- ---------------------------------------------------POPUP--------------------------------------------------------------------------- -->  
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          ...
          <form role="form" onsubmit="return validate()" action="index.php?action=operations/stockadvanceupdate&c=stock" method="POST">        
          ...
          <input type="hidden" name="billno" id="billno" value="<?php echo $_GET["bill_no"]?>">
          <div class="row">
            <!-- left column -->
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <br/>
                 <?php 
                           $b_no=$_GET["bill_no"];
                            ...
                            ?>
                <?php $advance=0;
	          $data = mysql_query("SELECT bill_no, customer_name, phone, city, bill_date, advance, login_id, branch FROM customerbillmainadvance where bill_no='".$b_no."'");
	          while($info = mysql_fetch_array( $data ))
	          {$advance=$info['advance'];
	          
	          $data3 = mysql_query("SELECT note FROM customer_transactions where bill_no='".$b_no."'");
	          ...
	          ?>
                ...
                <tr>
                	...
                	<td>Buyer&nbsp; Name *</td><td id='b_name_v'><input type="text" value='<?php echo $info['customer_name']?>' class="form-control" id="b_name" name="b_name"  style="width: 150px"> </td><td>&nbsp;&nbsp;</td>
                	
                	
                	

                	
                	<td>Mobile</td><td id='mobile_v'><input type="text" maxlength="10" class="form-control onlyNumbers" id="mobile" name="mobile" value='<?php echo $info["phone"]?>'></td><td>&nbsp;&nbsp;</td>
                	<td>Place</td><td id='place_v'><input type="text" class="form-control" id="place" name="place" value='<?php echo $info["city"]?>' style="width: 160px"></td><td>&nbsp;&nbsp;</td>
              ...
              <div class="box">
	           ...
	           <?php 
	           $i=1;
	           $data = mysql_query("SELECT bill_no, item_date, item_name, item_qty, item_rate, amt, item_qty_p FROM customerbilladvance where bill_no='".$b_no."'");
	           while($info = mysql_fetch_array( $data ))
	           {
	           ?>
	           <tr>
	           		<td><select class="form-control" id="flower<?php echo $i?>">
	           		 ...
	           		 <?php 
                                  ...
                                  $data2 = mysql_query("SELECT item_name FROM items where item_status='active'");
                                  while($info2 = mysql_fetch_array( $data2 ))
                                  {
                                  ?>  
	               <option  value="<?php echo $info2["item_name"]?>"><?php echo $info2["item_name"]?></option>
	               <?php }?>
	           		
	           		</select>
	           		</td>
	           		
	           		<td><input type="text" class="form-control" id="cost<?php echo $i?>" onblur="calCost(<?php echo $i?>)" value='<?php echo $info["item_rate"]?>'/></td>
	           ...
	           <tr>
	           		...
	           		<option value=''></option>
	           		 ...
	           		 <?php 
                                  ...
                                  $data = mysql_query("SELECT item_name FROM items where item_status='active'");
                                  while($info = mysql_fetch_array( $data ))
                                  {
                                  ?>  
	               <option  value="<?php echo $info["item_name"]?>"><?php echo $info["item_name"]?></option>
	          ...
	          <input type='hidden' id='count' value='<?php echo $i?>'>
	           ...
	           <div class="span6">
	          <table>
	             <tr><td>Advance&nbsp;Amount*</td><td><input type="text" value='<?php echo $advance?>' class="form-control" onfocus="finalCost()" id="grand_total" name="grand_total" data-validation-minlength="0" data-trigger="change" data-required="true"  data-type="number" /></td></tr>
	           <tr><td>Note</td><td><textarea name='note' id='note' class="form-control"><?php echo $note?></textarea></td></tr>
	           </table>	           
	           </div>
	           <div class="span10">
